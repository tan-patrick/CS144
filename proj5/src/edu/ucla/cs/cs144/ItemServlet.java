...
public class ItemServlet extends HttpServlet implements Servlet {
	...
	static String processAttrStringBuyPrice(String attr)
	{
		if (attr.equals("\\N"))
			return "none <br>";
		else
			return attr + "<a href=\"/eBay/inputCard\"> Pay Now </a> <br>";
	}
	
	static String processItemXML(Element e)
	{
		...
		itemInfo += "<b>Current Bid: </b>\t" +  processAttrString(currently)  +
					"<b>Buy Price: </b>\t" + processAttrStringBuyPrice(buy_price) + 
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
		...
		try {
			DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
			DocumentBuilder builder = factory.newDocumentBuilder();
			Document document = builder.parse(new InputSource(new StringReader(itemXML)));
			e = document.getDocumentElement();
		}
		catch(Exception error){};
		
		String itemInfo = processItemXML(e);
		request.setAttribute("item", itemInfo);
		
	    session.setAttribute("itemID", e.getAttribute("ItemID")); 
	    session.setAttribute("itemName", getElementTextByTagNameNR(e, "Name")); 
	    session.setAttribute("buyPrice", getElementTextByTagNameNR(e, "Buy_Price")); 
